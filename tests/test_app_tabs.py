...
TAB_MARKERS = {
    "Обзор": [
        "Суточный энергоаудит",
        "Куда уходит подведённая мощность",
        "Топ-мероприятия",
        "Паспорт и режим",
    ],
...
UNFIT_TAB_MARKERS = {
    "Обзор": ["Суточный энергоаудит", "Паспорт и режим"],
...
def test_overview_answers_manager_questions(at_kns54):
    ...
    if at_kns54.error:
        ...
        assert "Куда уходит подведённая мощность" in text and "Топ-мероприятия" in text
