...
import TelemetryCalendar, {
  TelemetryCalendarData,
  TelemetryCalendarState,
} from "./TelemetryCalendar";
...
const TelemetryCalendarRoot: FrontendRenderer<
  TelemetryCalendarState,
  TelemetryCalendarData
> = (args) => {
  ...
  reactRoot.render(
    <StrictMode>
      <TelemetryCalendar data={data} setStateValue={setStateValue} />
    </StrictMode>,
  );
...
export default TelemetryCalendarRoot;
