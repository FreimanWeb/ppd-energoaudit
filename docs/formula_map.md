...
Упоминания ДНС-7с ниже относятся к статичному YAML/reference case, сохранённому
для проверки формул. Исходные Excel-временные ряды ДНС-7с в текущем checkout
недоступны и не являются источником телеметрии SQLite.
